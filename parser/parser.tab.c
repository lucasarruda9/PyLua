...
#include <stdio.h>
#include <stdlib.h>
#include "../ast/ast.h"  // Incluindo o arquivo AST para manipulação dos nós da AST
...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "SEMICOLON", "LPAREN", "RPAREN", "ERROR",
...
{
      -6,    11,    -6,     9,    -6,    10,    10,    -6,    -2,    -6,
      -6,    17,    10,    10,    10,    10,    -6,    -6,    19,    19,
      -6,    -6
};
...
static const yytype_int8 yytable[] =
{
      ...
      21,     2,     3,     4,     4,     5,     5,     9,     0,     6,
       6,    12,    13,    14,    15,    14,    15,    17
};

static const yytype_int8 yycheck[] =
{
       5,     6,     4,     5,     6,     7,     8,    12,    13,    14,
      15,     0,     1,     3,     3,     5,     5,     8,    -1,     9,
       9,     4,     5,     6,     7,     6,     7,    10
};
...
{
       0,    14,     0,     1,     3,     5,     9,    15,    16,     8,
      16,    16,     4,     5,     6,     7,     8,    10,    16,    16,
      16,    16
};
...
#line 1096 "parser.tab.c"
  ...
  case 6: /* expr: INTEGER  */
#line 47 "parser.y"
                               { (yyval.node) = create_literal_node((yyvsp[0].intval)); }
...
#line 52 "parser.y"
                               { 
                                if ((yyvsp[0].node) == 0) {  // Verifica se a divisão é por zero
                                    yyerror("Divisão por zero");
                                    (yyval.node) = create_literal_node(0);  // Retorna 0 em caso de erro
                                } else {
                                    (yyval.node) = create_binary_op_node('/', (yyvsp[-2].node), (yyvsp[0].node));  // Realiza a divisão
                                }
                              }
